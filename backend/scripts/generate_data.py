"""Generate sample data for Financial Services context graph."""
...
async def main():
    print("Seeding Financial Services context graph...")
    ...
    await close_neo4j()
    print("\nDone! Your Financial Services context graph is ready.")
